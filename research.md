...
<br />
  ...
  <div class="research-section">
    ...
    <div class="research-content">
      ...
      <p>   
        Ozone is an air pollutant that harms human health, damages vegetation, and acts as a short-lived climate forcer. Despite being the most-measured trace gas in the atmosphere, global models still disagree on even basic ozone trends and spatial patterns. Accurately predicting ozone requires capturing nearly every major process in the atmosphere (e.g., emissions, chemistry, stratosphere-troposphere exchange, and boundary layer mixing). Deep learning is well-suited for this problem as it can identify complex, non-obvious interactions in air pollution data and accelerate expensive chemical computations. Our past work explored how AI can emulate and replace computationally costly components of global atmospheric models for fast, stable simulations. Our current research probes what AI foundation models actually learn about atmospheric chemistry and the extent to which they can complement or substitute for process-based models. We develop architectures that improve chemical generalization and work toward physically consistent foundation models that blend data-driven and mechanistic components to better diagnose what drives ozone bias.
